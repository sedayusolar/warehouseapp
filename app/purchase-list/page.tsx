            ...
            <div className="hidden">
                <div className="p-5 flex justify-between items-center">
                    <div>
                        ...
                        <h1 className="text-xl font-black">Purchase Order</h1>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        {user.role !== 'MANAGER' && (
                            <button onClick={() => router.push('/purchase')}
                                className="bg-blue-600 text-white font-black px-3 py-2 rounded-xl text-xs uppercase shadow-md active:scale-95">
                                ＋ Input PO
                            </button>
                        )}
                    </div>
